...
support_files = [
    ...
    'preview/render-preview.mjs', 'preview/verify-commerce.mjs', 'preview/verify-quiz.mjs', 'preview/verify-editorial.mjs',
    'SCENT-QUIZ.md', 'HOMEPAGE-PROMPTS.json', 'HOMEPAGE-ASSET-QA.json',
]
...
# Serve the complete editable source beside the uploadable theme.
(public/'DearBody-Website-Source.zip').write_bytes((root/'DearBody-Website-Source.zip').read_bytes())
