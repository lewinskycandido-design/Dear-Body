...
const previewPort = Number(process.env.PORT || 4175);
...
async function build() {
  ...
  const report = {
    generatedAt: new Date().toISOString(), edition: 'DearBody Bauhaus', previewPort, themeRoot, routes, validation,
