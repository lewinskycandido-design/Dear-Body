...
try render(base: "08-product-profile-base.png", output: "08-product-profile-infographic.png") {
    drawText("MISTENED NARCISSUS", x: 112, y: 122, width: 760, height: 36, size: 23, weight: .bold, color: coral)
    ...
    drawText("P11438", x: 112, y: 1123, width: 500, height: 48, size: 31, weight: .bold)
}

try render(base: "09-ingredients-care-base.png", output: "09-ingredients-and-care-infographic.png") {
    let startX: CGFloat = 1120
    drawText("MISTENED NARCISSUS", x: startX, y: 118, width: 820, height: 36, size: 23, weight: .bold, color: coral)
    ...
    let rightIngredients = "Hexyl Cinnamal\nLimonene\nLinalool\nCitronellol\nAlpha-Isomethyl Ionone"
...
try render(base: "10-closing-hero-base.png", output: "10-closing-hero.png") {
    ...
    drawText("MISTENED NARCISSUS", x: 96, y: 292, width: 760, height: 38, size: 24, weight: .bold, color: coral, shadow: shadow)
...
try render(base: "11-scent-description-base.png", output: "11-scent-description-infographic.png") {
    ...
    drawText("MISTENED NARCISSUS", x: 112, y: 128, width: 700, height: 36, size: 23, weight: .bold, color: coral)
...
try render(base: "12-who-it-fits-base.png", output: "12-who-it-fits-infographic.png") {
    ...
    drawText("MISTENED NARCISSUS", x: 92, y: 118, width: 680, height: 36, size: 23, weight: .bold, color: coralLight)
