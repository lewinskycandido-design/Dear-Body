...
func render(base: String, output: String, overlay: () -> Void) throws {
    ...
    let outputURL = root.appendingPathComponent("final").appendingPathComponent(output)
    try data.write(to: outputURL)
}

try render(base: "08-product-profile-base.png", output: "08-product-profile-infographic.png") {
    drawText("OUD MIRAGE", x: 112, y: 122, width: 700, height: 36, size: 23, weight: .bold, color: coral)
    ...
    drawText("P10238", x: 112, y: 1123, width: 500, height: 48, size: 31, weight: .bold)
}

try render(base: "09-ingredients-care-base.png", output: "09-ingredients-and-care-infographic.png") {
    let startX: CGFloat = 875
    drawText("OUD MIRAGE", x: startX, y: 118, width: 900, height: 36, size: 23, weight: .bold, color: coral)
    ...
    let rightIngredients = "Benzyl Benzoate\nCitronellol\nGeraniol\nCoumarin\nBenzyl Alcohol\nLimonene"
...
try render(base: "10-closing-hero-base.png", output: "10-closing-hero.png") {
    ...
    drawText("OUD MIRAGE", x: 96, y: 210, width: 600, height: 38, size: 24, weight: .bold, color: coral, shadow: shadow)
...
try render(base: "11-scent-description-base.png", output: "11-scent-description-infographic.png") {
    ...
    drawText("OUD MIRAGE", x: 112, y: 128, width: 620, height: 36, size: 23, weight: .bold, color: coral)
    ...
    drawText(
        "Dark rose wrapped in smoky, woody depth.",
        x: 112,
        y: 554,
        width: 590,
        height: 430,
...
try render(base: "12-who-it-fits-base.png", output: "12-who-it-fits-infographic.png") {
    fillRect(
        ...
        width: 660,
        height: 2048,
        color: NSColor(calibratedWhite: 0.055, alpha: 0.94)
    )
    fillRect(x: 660, y: 0, width: 16, height: 2048, color: coral)

    drawText("OUD MIRAGE", x: 92, y: 118, width: 500, height: 36, size: 23, weight: .bold, color: coral)
    ...
    drawText(
        "For someone drawn to expressive style, deep contrasts, and a quietly bold presence.",
        x: 92,
        y: 492,
        width: 500,
        height: 500,
