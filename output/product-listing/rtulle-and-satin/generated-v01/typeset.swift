...
try render(base: "08-product-profile-base.png", output: "08-product-profile-infographic.png") {
    drawText("RTULLE & SATIN", x: 112, y: 122, width: 700, height: 36, size: 23, weight: .bold, color: coral)
    ...
    drawText("P10038", x: 112, y: 1123, width: 500, height: 48, size: 31, weight: .bold)
}

try render(base: "09-ingredients-care-base.png", output: "09-ingredients-and-care-infographic.png") {
    let startX: CGFloat = 875
    drawText("RTULLE & SATIN", x: startX, y: 118, width: 900, height: 36, size: 23, weight: .bold, color: coral)
...
try render(base: "10-closing-hero-base.png", output: "10-closing-hero.png") {
    ...
    drawText("RTULLE & SATIN", x: 96, y: 210, width: 600, height: 38, size: 24, weight: .bold, color: coral, shadow: shadow)
