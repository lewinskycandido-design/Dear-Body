# Charme Envoûtant — 12-Image Gallery
...
- Generation mode: built-in ImageGen, followed by deterministic AppKit typesetting for frames 08–12
- Product identity: Dear Body / Parfum London, men's black-label line
...
8. `final/08-product-profile-infographic.png` — Verified product profile infographic.
9. `final/09-ingredients-and-care-infographic.png` — Printed ingredients, pack details, and flammability care.
10. `final/10-closing-hero.png` — Manila rooftop closing image with “A SCENT JOURNEY.”
11. `final/11-scent-description-infographic.png` — Owner-approved scent description from the Dear Body Brand Deep Dive.
12. `final/12-who-it-fits-infographic.png` — Inclusive person-fit interpretation derived only from the approved scent description.

## Verified Facts Used

- Product name: Charme Envoûtant
- Brand shown on pack: Parfum London / Dear Body
...
- Approved scent description: “Rich, spiced sweetness that feels deep and indulgent.”
- Scent-description source: Canva design `DAHIB2UjgJM`, Dear Body Brand Deep Dive, page 3

## Printed Ingredients

Alcohol; Water (Aqua); Fragrance (Parfum); PEG-40 Hydrogenated Castor Oil; Propylene Glycol; Coumarin; Limonene; Linalool; Cinnamal; Eugenol; Benzyl Benzoate.
...
8. Text-free product-profile base with products grouped right and calm cream copy space left.
9. Text-free split base with bottle on black velvet and an empty cream information panel.
10. Text-free Manila rooftop closing base with products lower-right and headline space upper-left.
11. High-contrast scent-description infographic using the exact owner-approved sentence and exact bottle-and-canister imagery.
12. High-contrast `WHO IT FITS` infographic using the approved convertible lifestyle frame and a restrained editorial interpretation: “For someone drawn to warm depth, expressive style, and an indulgent finishing touch.”

No fragrance notes, scent family, concentration, longevity, projection, occasion, performance, or usage claims were invented. Frame 12 is an editorial interpretation, not a product-performance claim.
