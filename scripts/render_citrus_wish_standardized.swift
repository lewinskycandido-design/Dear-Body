...
let citrus = NSColor(calibratedRed: 226 / 255, green: 166 / 255, blue: 0 / 255, alpha: 1)
...
let working = "\(root)/output/product-listing/citrus-wish/standardized-v01/working"
let final = "\(root)/output/product-listing/citrus-wish/standardized-v01/final"
...
try render(base: profileBase, output: "\(final)/08-product-profile-infographic.png") {
    text("CITRUS WISH", x: 110, y: 105, width: 860, height: 44, size: 25, color: oxblood, bold: true, kern: 3)
    text("PRODUCT\nPROFILE", x: 110, y: 175, width: 820, height: 220, size: 78, color: ink, bold: true, lineHeight: 84)
    line(x: 110, y: 438, width: 285, color: citrus)
    ...
    text("PRODUCT CODE  P10638", x: 110, y: 1695, width: 800, height: 52, size: 29, color: cream, bold: true, kern: 0.5)
    line(x: 110, y: 1775, width: 205, color: citrus, height: 6)
}

try render(base: ingredientsBase, output: "\(final)/09-ingredients-and-care-infographic.png") {
    text("CITRUS WISH", x: 965, y: 100, width: 940, height: 42, size: 24, color: oxblood, bold: true, kern: 3)
    text("INGREDIENTS", x: 965, y: 170, width: 940, height: 78, size: 61, color: ink, bold: true)
    line(x: 965, y: 274, width: 310, color: citrus)
...
try render(base: closingBase, output: "\(final)/10-closing-hero.png") {
    ...
    text("CITRUS WISH", x: 110, y: 220, width: 800, height: 46, size: 27, color: citrus, bold: true, kern: 3)
    line(x: 110, y: 292, width: 250, color: citrus, height: 6)
}

print("Rendered Citrus Wish standardized frames 08-10")
